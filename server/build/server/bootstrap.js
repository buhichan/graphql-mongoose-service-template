        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    switch (_a) {
                        case "production": return [3 /*break*/, 1];
                        case "prerelease": return [3 /*break*/, 3];
                    }
                    return [3 /*break*/, 5];
                case 1: return [4 /*yield*/, Promise.resolve().then(function () { return require("./env/production"); })];
                case 2:
                    _f.sent();
                    return [3 /*break*/, 7];
                case 3: return [4 /*yield*/, Promise.resolve().then(function () { return require("./env/prerelease"); })];
                case 4:
                    _f.sent();
                    return [3 /*break*/, 7];
                case 5: return [4 /*yield*/, Promise.resolve().then(function () { return require("./env/development"); })];
                case 6:
                    _f.sent();
                    _f.label = 7;
